...
with open("emoji_data.json", "w") as file:
    json.dump(puzzles, file, indent=2)
print("emoji_data.json created!")
loader = ContentLoader("emoji_data.json")
print("\nEasy:")
print(loader.get_by_difficulty("Easy"))
print("\nMedium:")
print(loader.get_by_difficulty("Medium"))
print("\nHard:")
print(loader.get_by_difficulty("Hard"))